 ...
 * @since 3.0.0
 */
export interface FromReader2<F extends HKT2> {
  readonly URI?: F
 ...
 * @since 3.0.0
 */
export interface FromReader3<F extends HKT3> {
  readonly URI?: F
 ...
 * @since 3.0.0
 */
export interface FromReader3C<F extends HKT3, E> {
  readonly URI?: F
  readonly _E?: E
 ...
 * @since 3.0.0
 */
export interface FromReader4<F extends HKT4> {
  readonly URI?: F
 ...
 * @since 3.0.0
 */
export function ask<F extends HKT4>(F: FromReader4<F>): <S, R, E>() => Kind4<F, S, R, E, R>
export function ask<F extends HKT3>(F: FromReader3<F>): <R, E>() => Kind3<F, R, E, R>
export function ask<F extends HKT3, E>(F: FromReader3C<F, E>): <R>() => Kind3<F, R, E, R>
export function ask<F extends HKT2>(F: FromReader2<F>): <R>() => Kind2<F, R, R>
export function ask<F>(F: FromReader<F>): <R>() => Kind2<F, R, R>
export function ask<F>(F: FromReader<F>): <R>() => Kind2<F, R, R> {
 ...
 * @since 3.0.0
 */
export function asks<F extends HKT4>(F: FromReader4<F>): <R, A, S, E>(f: (r: R) => A) => Kind4<F, S, R, E, A>
export function asks<F extends HKT3>(F: FromReader3<F>): <R, A, E>(f: (r: R) => A) => Kind3<F, R, E, A>
export function asks<F extends HKT3, E>(F: FromReader3C<F, E>): <R, A>(f: (r: R) => A) => Kind3<F, R, E, A>
export function asks<F extends HKT2>(F: FromReader2<F>): <R, A>(f: (r: R) => A) => Kind2<F, R, A>
export function asks<F>(F: FromReader<F>): <R, A>(f: (r: R) => A) => Kind2<F, R, A>
export function asks<F>(F: FromReader<F>): <R, A>(f: (r: R) => A) => Kind2<F, R, A> {
  return F.fromReader
}
 ...
 * @since 3.0.0
 */
export function chainReaderK<M extends HKT4>(
  F: FromReader4<M>,
  M: Chain4<M>
): <A, R, B>(f: (a: A) => Reader<R, B>) => <S, E>(ma: Kind4<M, S, R, E, A>) => Kind4<M, S, R, E, B>
export function chainReaderK<M extends HKT3>(
  F: FromReader3<M>,
  M: Chain3<M>
): <A, R, B>(f: (a: A) => Reader<R, B>) => <E>(ma: Kind3<M, R, E, A>) => Kind3<M, R, E, B>
export function chainReaderK<M extends HKT3, E>(
  F: FromReader3C<M, E>,
  M: Chain3C<M, E>
): <A, R, B>(f: (a: A) => Reader<R, B>) => (ma: Kind3<M, R, E, A>) => Kind3<M, R, E, B>
export function chainReaderK<M extends HKT2>(
  F: FromReader2<M>,
  M: Chain2<M>
 ...
 * @since 3.0.0
 */
export function chainFirstReaderK<M extends HKT4>(
  F: FromReader4<M>,
  M: Chain4<M>
): <A, R, B>(f: (a: A) => Reader<R, B>) => <S, E>(ma: Kind4<M, S, R, E, A>) => Kind4<M, S, R, E, A>
export function chainFirstReaderK<M extends HKT3>(
  F: FromReader3<M>,
  M: Chain3<M>
): <A, R, B>(f: (a: A) => Reader<R, B>) => <E>(ma: Kind3<M, R, E, A>) => Kind3<M, R, E, A>
export function chainFirstReaderK<M extends HKT3, E>(
  F: FromReader3C<M, E>,
  M: Chain3C<M, E>
): <A, R, B>(f: (a: A) => Reader<R, B>) => (ma: Kind3<M, R, E, A>) => Kind3<M, R, E, A>
export function chainFirstReaderK<M extends HKT2>(
  F: FromReader2<M>,
  M: Chain2<M>
