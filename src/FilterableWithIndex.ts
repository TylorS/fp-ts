 ...
 * @since 3.0.0
 */
export interface FilterWithIndex1<F extends HKT, I> {
  <A, B extends A>(refinementWithIndex: RefinementWithIndex<I, A, B>): (fa: Kind<F, A>) => Kind<F, B>
  <A>(predicateWithIndex: PredicateWithIndex<I, A>): <B extends A>(fb: Kind<F, B>) => Kind<F, B>
  <A>(predicateWithIndex: PredicateWithIndex<I, A>): (fa: Kind<F, A>) => Kind<F, A>
}
 ...
 * @since 3.0.0
 */
export interface PartitionWithIndex1<F extends HKT, I> {
  <A, B extends A>(refinementWithIndex: RefinementWithIndex<I, A, B>): (
    fa: Kind<F, A>
  ) => Separated<Kind<F, A>, Kind<F, B>>
  <A>(predicateWithIndex: PredicateWithIndex<I, A>): <B extends A>(fb: Kind<F, B>) => Separated<Kind<F, B>, Kind<F, B>>
 ...
 * @since 3.0.0
 */
export interface FilterableWithIndex1<F extends HKT, I> {
  readonly URI?: F
  readonly partitionMapWithIndex: <A, B, C>(
    f: (i: I, a: A) => Either<B, C>
  ) => (fa: Kind<F, A>) => Separated<Kind<F, B>, Kind<F, C>>
 ...
 * @since 3.0.0
 */
export interface FilterWithIndex2<F extends HKT2, I> {
 ...
 * @since 3.0.0
 */
export interface PartitionWithIndex2<F extends HKT2, I> {
 ...
 * @since 3.0.0
 */
export interface FilterableWithIndex2<F extends HKT2, I> {
  readonly URI?: F
  readonly partitionMapWithIndex: <A, B, C>(
    f: (i: I, a: A) => Either<B, C>
 ...
 * @since 3.0.0
 */
export interface FilterWithIndex2C<F extends HKT2, I, E> {
 ...
 * @since 3.0.0
 */
export interface PartitionWithIndex2C<F extends HKT2, I, E> {
  <A, B extends A>(refinementWithIndex: RefinementWithIndex<I, A, B>): (
    fa: Kind2<F, E, A>
  ) => Separated<Kind2<F, E, A>, Kind2<F, E, B>>
 ...
 * @since 3.0.0
 */
export interface FilterableWithIndex2C<F extends HKT2, I, E> {
  readonly URI?: F
  readonly _E?: E
  readonly partitionMapWithIndex: <A, B, C>(
    f: (i: I, a: A) => Either<B, C>
 ...
 * @since 3.0.0
 */
export interface FilterWithIndex3<F extends HKT3, I> {
 ...
 * @since 3.0.0
 */
export interface PartitionWithIndex3<F extends HKT3, I> {
  <A, B extends A>(refinementWithIndex: RefinementWithIndex<I, A, B>): <R, E>(
    fa: Kind3<F, R, E, A>
 ...
 * @since 3.0.0
 */
export interface FilterableWithIndex3<F extends HKT3, I> {
  readonly URI?: F
  readonly partitionMapWithIndex: <A, B, C>(
    f: (i: I, a: A) => Either<B, C>
 ...
 * @since 3.0.0
 */
export interface FilterWithIndex4<F extends HKT4, I> {
 ...
 * @since 3.0.0
 */
export interface PartitionWithIndex4<F extends HKT4, I> {
  <A, B extends A>(refinementWithIndex: RefinementWithIndex<I, A, B>): <S, R, E>(
    fa: Kind4<F, S, R, E, A>
 ...
 * @since 3.0.0
 */
export interface FilterableWithIndex4<F extends HKT4, I> {
  readonly URI?: F
  readonly partitionMapWithIndex: <A, B, C>(
    f: (i: I, a: A) => Either<B, C>
