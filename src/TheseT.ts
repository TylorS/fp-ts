 ...
 * @since 3.0.0
 */
export function right<F extends HKT3>(F: Pointed3<F>): <A, S, R, E = never>(a: A) => Kind3<F, S, R, These<E, A>>
export function right<F extends HKT3, R>(F: Pointed3C<F, R>): <A, S, E = never>(a: A) => Kind3<F, S, R, These<E, A>>
export function right<F extends HKT2>(F: Pointed2<F>): <A, R, E = never>(a: A) => Kind2<F, R, These<E, A>>
export function right<F extends HKT2, R>(F: Pointed2C<F, R>): <A, E = never>(a: A) => Kind2<F, R, These<E, A>>
export function right<F extends HKT>(F: Pointed1<F>): <A, E = never>(a: A) => Kind<F, These<E, A>>
export function right<F>(F: Pointed<F>): <A, E = never>(a: A) => Kind<F, These<E, A>>
export function right<F>(F: Pointed<F>): <A, E = never>(a: A) => Kind<F, These<E, A>> {
 ...
 * @since 3.0.0
 */
export function left<F extends HKT3>(F: Pointed3<F>): <E, S, R, A = never>(e: E) => Kind3<F, S, R, These<E, A>>
export function left<F extends HKT3, R>(F: Pointed3C<F, R>): <E, S, A = never>(e: E) => Kind3<F, S, R, These<E, A>>
export function left<F extends HKT2>(F: Pointed2<F>): <E, R, A = never>(e: E) => Kind2<F, R, These<E, A>>
export function left<F extends HKT2, R>(F: Pointed2C<F, R>): <E, A = never>(e: E) => Kind2<F, R, These<E, A>>
export function left<F extends HKT>(F: Pointed1<F>): <E, A = never>(e: E) => Kind<F, These<E, A>>
export function left<F>(F: Pointed<F>): <E, A = never>(e: E) => Kind<F, These<E, A>>
export function left<F>(F: Pointed<F>): <E, A = never>(e: E) => Kind<F, These<E, A>> {
 ...
 * @since 3.0.0
 */
export function both<F extends HKT3>(F: Pointed3<F>): <E, A, S, R>(e: E, a: A) => Kind3<F, S, R, These<E, A>>
export function both<F extends HKT3, R>(F: Pointed3C<F, R>): <E, A, R>(e: E, a: A) => Kind3<F, R, R, These<E, A>>
export function both<F extends HKT2>(F: Pointed2<F>): <E, A, R>(e: E, a: A) => Kind2<F, R, These<E, A>>
export function both<F extends HKT2, R>(F: Pointed2C<F, R>): <E, A>(e: E, a: A) => Kind2<F, R, These<E, A>>
export function both<F extends HKT>(F: Pointed1<F>): <E, A>(e: E, a: A) => Kind<F, These<E, A>>
export function both<F>(F: Pointed<F>): <E, A = never>(e: E, a: A) => Kind<F, These<E, A>>
export function both<F>(F: Pointed<F>): <E, A = never>(e: E, a: A) => Kind<F, These<E, A>> {
...
export function rightF<F extends HKT3, R>(
  F: Functor3C<F, R>
...
export function rightF<F extends HKT2, R>(
  F: Functor2C<F, R>
): <A, E = never>(fa: Kind2<F, R, A>) => Kind2<F, R, These<E, A>>
export function rightF<F extends HKT>(F: Functor1<F>): <A, E = never>(fa: Kind<F, A>) => Kind<F, These<E, A>>
export function rightF<F>(F: Functor<F>): <A, E = never>(fa: Kind<F, A>) => Kind<F, These<E, A>>
export function rightF<F>(F: Functor<F>): <A, E = never>(fa: Kind<F, A>) => Kind<F, These<E, A>> {
...
export function leftF<F extends HKT3, R>(
  F: Functor3C<F, R>
...
export function leftF<F extends HKT2, R>(
  F: Functor2C<F, R>
): <E, A = never>(fe: Kind2<F, R, E>) => Kind2<F, R, These<E, A>>
export function leftF<F extends HKT>(F: Functor1<F>): <E, A = never>(fe: Kind<F, E>) => Kind<F, These<E, A>>
export function leftF<F>(F: Functor<F>): <E, A = never>(fe: Kind<F, E>) => Kind<F, These<E, A>>
export function leftF<F>(F: Functor<F>): <E, A = never>(fe: Kind<F, E>) => Kind<F, These<E, A>> {
  return F.map(T.left)
}
...
export function map<F extends HKT3, R>(
  F: Functor3C<F, R>
...
export function map<F extends HKT2, R>(
  F: Functor2C<F, R>
...
export function map<F>(F: Functor<F>): <A, B>(f: (a: A) => B) => <E>(fa: Kind<F, These<E, A>>) => Kind<F, These<E, B>>
export function map<F>(F: Functor<F>): <A, B>(f: (a: A) => B) => <E>(fa: Kind<F, These<E, A>>) => Kind<F, These<E, B>> {
...
export function ap<F extends HKT3, R, E>(
  F: Apply3C<F, R>,
  S: Semigroup<E>
): <S, A>(
  fa: Kind3<F, S, R, These<E, A>>
...
export function ap<F extends HKT2, R, E>(
  F: Apply2C<F, R>,
  S: Semigroup<E>
...
export function chain<M extends HKT3, R, E>(
  M: Monad3C<M, R>,
  S: Semigroup<E>
): <A, S, B>(
  f: (a: A) => Kind3<M, S, R, These<E, B>>
...
export function chain<M extends HKT2, R, E>(
  M: Monad2C<M, R>,
  S: Semigroup<E>
...
export function bimap<F extends HKT3, R>(
  F: Functor3C<F, R>
...
export function bimap<F extends HKT2, R>(
  F: Functor2C<F, R>
...
export function mapLeft<F extends HKT3, R>(
  F: Functor3C<F, R>
...
export function mapLeft<F extends HKT2, R>(
  F: Functor2C<F, R>
...
export function match<F extends HKT3, R>(
  F: Functor3C<F, R>
): <E, B, A>(
  onLeft: (e: E) => B,
  onRight: (a: A) => B,
...
export function match<M extends HKT2, R>(
  F: Functor2C<M, R>
): <E, B, A>(
  onLeft: (e: E) => B,
  onRight: (a: A) => B,
...
export function matchE<M extends HKT3, R>(
  M: Chain3C<M, R>
): <E, S, B, A>(
  onLeft: (e: E) => Kind3<M, S, R, B>,
  onRight: (a: A) => Kind3<M, S, R, B>,
...
export function matchE<M extends HKT2, R>(
  M: Chain2C<M, R>
): <E, B, A>(
  onLeft: (e: E) => Kind2<M, R, B>,
  onRight: (a: A) => Kind2<M, R, B>,
...
export function swap<F extends HKT3, R>(
  F: Functor3C<F, R>
...
export function swap<F extends HKT2, R>(
  F: Functor2C<F, R>
): <E, A>(ma: Kind2<F, R, These<E, A>>) => Kind2<F, R, These<A, E>>
export function swap<F extends HKT>(F: Functor1<F>): <E, A>(ma: Kind<F, These<E, A>>) => Kind<F, These<A, E>>
export function swap<F>(F: Functor<F>): <E, A>(ma: Kind<F, These<E, A>>) => Kind<F, These<A, E>>
export function swap<F>(F: Functor<F>): <E, A>(ma: Kind<F, These<E, A>>) => Kind<F, These<A, E>> {
  return F.map(T.swap)
}
