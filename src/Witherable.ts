 ...
 * @since 3.0.0
 */
export interface Witherable1<T extends HKT> {
  readonly URI?: T
 ...
 * @since 3.0.0
 */
export interface Witherable2<T extends HKT2> {
  readonly URI?: T
 ...
 * @since 3.0.0
 */
export interface Witherable2C<T extends HKT2, E> {
  readonly URI?: T
  readonly _E?: E
 ...
 * @since 3.0.0
 */
export interface Witherable3<T extends HKT3> {
  readonly URI?: T
...
export interface Wither<W> {
  ...
  <F extends HKT>(F: Applicative1<F>): <A, B>(f: (a: A) => Kind<F, Option<B>>) => (ta: Kind<W, A>) => Kind<F, Kind<W, B>>
  <F>(F: Applicative<F>): <A, B>(f: (a: A) => Kind<F, Option<B>>) => (ta: Kind<W, A>) => Kind<F, Kind<W, B>>
}

/**
 * @since 3.0.0
 */
export interface Wither1<W extends HKT> {
  <F extends HKT3>(F: Applicative3<F>): <A, R, E, B>(
    f: (a: A) => Kind3<F, R, E, Option<B>>
  ) => (ta: Kind<W, A>) => Kind3<F, R, E, Kind<W, B>>
  <F extends HKT3, E>(F: Applicative3C<F, E>): <A, R, B>(
 ...
 * @since 3.0.0
 */
export interface Wither2<W extends HKT2> {
  ...
  <F>(F: Applicative<F>): <A, B>(f: (a: A) => Kind<F, Option<B>>) => <WE>(ta: Kind2<W, WE, A>) => Kind<F, Kind2<W, WE, B>>
}

/**
 * @since 3.0.0
 */
export interface Wither2C<W extends HKT2, E> {
  <F extends HKT3>(F: Applicative3<F>): <A, R, FE, B>(
    f: (a: A) => Kind3<F, R, FE, Option<B>>
  ...
  <F>(F: Applicative<F>): <A, B>(f: (a: A) => Kind<F, Option<B>>) => (ta: Kind2<W, E, A>) => Kind<F, Kind2<W, E, B>>
}

/**
 * @since 3.0.0
 */
export interface Wither3<W extends HKT3> {
...
export interface Wilt<W> {
  <F extends HKT3>(F: Applicative3<F>): <A, R, E, B, C>(
    f: (a: A) => Kind3<F, R, E, Either<B, C>>
  ) => (wa: Kind<W, A>) => Kind3<F, R, E, Separated<Kind<W, B>, Kind<W, C>>>
  <F extends HKT3, E>(F: Applicative3C<F, E>): <A, R, B, C>(
    f: (a: A) => Kind3<F, R, E, Either<B, C>>
  ) => (wa: Kind<W, A>) => Kind3<F, R, E, Separated<Kind<W, B>, Kind<W, C>>>
  <F extends HKT2>(F: Applicative2<F>): <A, E, B, C>(
    f: (a: A) => Kind2<F, E, Either<B, C>>
  ) => (wa: Kind<W, A>) => Kind2<F, E, Separated<Kind<W, B>, Kind<W, C>>>
  <F extends HKT2, E>(F: Applicative2C<F, E>): <A, B, C>(
    f: (a: A) => Kind2<F, E, Either<B, C>>
  ) => (wa: Kind<W, A>) => Kind2<F, E, Separated<Kind<W, B>, Kind<W, C>>>
  <F extends HKT>(F: Applicative1<F>): <A, B, C>(
 ...
 * @since 3.0.0
 */
export interface Wilt1<W extends HKT> {
  <F extends HKT3>(F: Applicative3<F>): <A, R, E, B, C>(
    f: (a: A) => Kind3<F, R, E, Either<B, C>>
  ) => (wa: Kind<W, A>) => Kind3<F, R, E, Separated<Kind<W, B>, Kind<W, C>>>
  <F extends HKT3, E>(F: Applicative3C<F, E>): <A, R, B, C>(
 ...
 * @since 3.0.0
 */
export interface Wilt2C<W extends HKT2, E> {
  <F extends HKT3>(F: Applicative3<F>): <A, R, FE, B, C>(
    f: (a: A) => Kind3<F, R, FE, Either<B, C>>
 ...
 * @since 3.0.0
 */
export interface Wilt3<W extends HKT3> {
  <F extends HKT3>(F: Applicative3<F>): <A, FR, FE, B, C>(
 ...
 * @since 3.0.0
 */
export function wiltDefault<W extends HKT2, E>(
  T: Traversable2C<W, E>,
  C: Compactable2C<W, E>
): Witherable2C<W, E>['wilt']
export function wiltDefault<W extends HKT>(T: Traversable1<W>, C: Compactable1<W>): Witherable1<W>['wilt']
 ...
 * @since 3.0.0
 */
export function witherDefault<W extends HKT2, E>(
  T: Traversable2C<W, E>,
  C: Compactable2C<W, E>
): Witherable2C<W, E>['wither']
export function witherDefault<W extends HKT>(T: Traversable1<W>, C: Compactable1<W>): Witherable1<W>['wither']
export function witherDefault<W>(T: Traversable<W>, C: Compactable<W>): Witherable<W>['wither']
export function witherDefault<W>(T: Traversable<W>, C: Compactable<W>): Witherable<W>['wither'] {
  return <F>(F: Applicative<F>): (<A, B>(f: (a: A) => Kind<F, Option<B>>) => (ta: Kind<W, A>) => Kind<F, Kind<W, B>>) => {
    const traverseF = T.traverse(F)
 ...
 * @since 3.0.0
 */
export interface FilterE1<G extends HKT> {
  <F extends HKT3>(F: Applicative3<F>): <A, E, R>(
    predicate: (a: A) => Kind3<F, R, E, boolean>
  ) => (ga: Kind<G, A>) => Kind3<F, R, E, Kind<G, A>>
  <F extends HKT3, E>(F: Applicative3C<F, E>): <A, R>(
    predicate: (a: A) => Kind3<F, R, E, boolean>
  ) => (ga: Kind<G, A>) => Kind3<F, R, E, Kind<G, A>>
  <F extends HKT2>(F: Applicative2<F>): <A, E>(
    predicate: (a: A) => Kind2<F, E, boolean>
  ) => (ga: Kind<G, A>) => Kind2<F, E, Kind<G, A>>
  <F extends HKT2, E>(F: Applicative2C<F, E>): <A>(
    predicate: (a: A) => Kind2<F, E, boolean>
  ) => (ga: Kind<G, A>) => Kind2<F, E, Kind<G, A>>
  <F extends HKT>(F: Applicative1<F>): <A>(
    predicate: (a: A) => Kind<F, boolean>
  ) => (ga: Kind<G, A>) => Kind<F, Kind<G, A>>
  <F>(F: Applicative<F>): <A>(predicate: (a: A) => Kind<F, boolean>) => (ga: Kind<G, A>) => Kind<F, Kind<G, A>>
}
 ...
 * @since 3.0.0
 */
export function filterE<G extends HKT>(W: Witherable1<G>): FilterE1<G>
