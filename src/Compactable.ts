 ...
 * @since 3.0.0
 */
export interface Compactable1<F extends HKT> {
  readonly URI?: F
  readonly compact: <A>(foa: Kind<F, Option<A>>) => Kind<F, A>
  readonly separate: <A, B>(fe: Kind<F, Either<A, B>>) => Separated<Kind<F, A>, Kind<F, B>>
}
 ...
 * @since 3.0.0
 */
export interface Compactable2<F extends HKT2> {
  readonly URI?: F
 ...
 * @since 3.0.0
 */
export interface Compactable2C<F extends HKT2, E> {
  readonly URI?: F
  readonly _E?: E
 ...
 * @since 3.0.0
 */
export interface Compactable3<F extends HKT3> {
  readonly URI?: F
 ...
 * @since 3.0.0
 */
export interface Compactable3C<F extends HKT3, E> {
  readonly URI?: F
  readonly _E?: E
 ...
 * @since 3.0.0
 */
export interface Compactable4<F extends HKT4> {
  readonly URI?: F
 ...
 * @since 3.0.0
 */
export function separateDefault<F extends HKT4>(
  F: Functor4<F>
): (compact: Compactable4<F>['compact']) => Compactable4<F>['separate']
export function separateDefault<F extends HKT3>(
  F: Functor3<F>
): (compact: Compactable3<F>['compact']) => Compactable3<F>['separate']
export function separateDefault<F extends HKT3, E>(
  F: Functor3C<F, E>
): (compact: Compactable3C<F, E>['compact']) => Compactable3C<F, E>['separate']
export function separateDefault<F extends HKT2>(
  F: Functor2<F>
): (compact: Compactable2<F>['compact']) => Compactable2<F>['separate']
export function separateDefault<F extends HKT2, E>(
  F: Functor2C<F, E>
 ...
 * @since 3.0.0
 */
export function compact<F extends HKT2, G extends HKT2, E>(
  F: Functor2<F>,
  G: Compactable2C<G, E>
): <FE, A>(fgoa: Kind2<F, FE, Kind2<G, E, Option<A>>>) => Kind2<F, FE, Kind2<G, E, A>>
export function compact<F extends HKT, G extends HKT2, E>(
  F: Functor1<F>,
  G: Compactable2C<G, E>
...
export function compact<F, G>(F: Functor<F>, G: Compactable<G>): <A>(fa: Kind<F, Kind<G, Option<A>>>) => Kind<F, Kind<G, A>>
 ...
 * @since 3.0.0
 */
export function separate<F extends HKT2, G extends HKT2, E>(
  F: Functor2<F>,
  C: Compactable2C<G, E>,
  G: Functor2<G>
): <FE, A, B>(
...
export function separate<F extends HKT, G extends HKT2, E>(
  F: Functor1<F>,
  C: Compactable2C<G, E>,
  G: Functor2<G>
