...
import type { HKT2, Kind, Kind2, Kind3, Kind4, HKT, HKT3, HKT4 } from './HKT'
 ...
 * @since 3.0.0
 */
export interface FromEither2C<F extends HKT2, E> {
  readonly URI?: F
  readonly _E?: E
 ...
 * @since 3.0.0
 */
export interface FromEither3C<F extends HKT3, E> {
  readonly URI?: F
  readonly _E?: E
 ...
 * @since 3.0.0
 */
export function fromOption<F extends HKT4>(
  F: FromEither4<F>
): <E>(onNone: Lazy<E>) => NaturalTransformation14C<OURI, F, E>
export function fromOption<F extends HKT3>(
  F: FromEither3<F>
): <E>(onNone: Lazy<E>) => NaturalTransformation13C<OURI, F, E>
export function fromOption<F extends HKT3, E>(
  F: FromEither3C<F, E>
): (onNone: Lazy<E>) => NaturalTransformation13C<OURI, F, E>
export function fromOption<F extends HKT2>(
  F: FromEither2<F>
): <E>(onNone: Lazy<E>) => NaturalTransformation12C<OURI, F, E>
export function fromOption<F extends HKT2, E>(
  F: FromEither2C<F, E>
): (onNone: Lazy<E>) => NaturalTransformation12C<OURI, F, E>
export function fromOption<F>(F: FromEither<F>): <E>(onNone: Lazy<E>) => <A>(ma: Option<A>) => Kind2<F, E, A>
export function fromOption<F>(F: FromEither<F>): <E>(onNone: Lazy<E>) => <A>(ma: Option<A>) => Kind2<F, E, A> {
 ...
 * @since 3.0.0
 */
export function fromPredicate<F extends HKT4>(
  F: FromEither4<F>
): {
...
export function fromPredicate<F extends HKT3>(
  F: FromEither3<F>
): {
...
export function fromPredicate<F extends HKT2>(
  F: FromEither2<F>
): {
 ...
 * @since 3.0.0
 */
export function chainEitherK<M extends HKT4>(
  F: FromEither4<M>,
  M: Chain4<M>
): <A, E, B>(f: (a: A) => Either<E, B>) => <S, R>(ma: Kind4<M, S, R, E, A>) => Kind4<M, S, R, E, B>
export function chainEitherK<M extends HKT3>(
  F: FromEither3<M>,
  M: Chain3<M>
): <A, E, B>(f: (a: A) => Either<E, B>) => <R>(ma: Kind3<M, R, E, A>) => Kind3<M, R, E, B>
export function chainEitherK<M extends HKT3, E>(
  F: FromEither3C<M, E>,
  M: Chain3C<M, E>
): <A, B>(f: (a: A) => Either<E, B>) => <R>(ma: Kind3<M, R, E, A>) => Kind3<M, R, E, B>
export function chainEitherK<M extends HKT2>(
  F: FromEither2<M>,
  M: Chain2<M>
): <A, E, B>(f: (a: A) => Either<E, B>) => (ma: Kind2<M, E, A>) => Kind2<M, E, B>
export function chainEitherK<M extends HKT2, E>(
  F: FromEither2C<M, E>,
  M: Chain2C<M, E>
 ...
 * @since 3.0.0
 */
export function filterOrElse<M extends HKT4>(
  F: FromEither4<M>,
  M: Chain4<M>
): {
...
export function filterOrElse<M extends HKT3>(
  F: FromEither3<M>,
  M: Chain3<M>
): {
...
export function filterOrElse<M extends HKT3, E>(
  F: FromEither3C<M, E>,
  M: Chain3C<M, E>
): {
...
export function filterOrElse<M extends HKT2>(
  F: FromEither2<M>,
  M: Chain2<M>
): {
...
export function filterOrElse<M extends HKT2, E>(
  F: FromEither2C<M, E>,
  M: Chain2C<M, E>
): {
