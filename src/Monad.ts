...
import type { HKT, HKT2, HKT3, HKT4 } from './HKT'
 ...
 * @since 3.0.0
 */
export interface Monad1<M extends HKT> extends Pointed1<M>, Chain1<M> {}

/**
 * @category type classes
 * @since 3.0.0
 */
export interface Monad2<M extends HKT2> extends Pointed2<M>, Chain2<M> {}

/**
 * @category type classes
 * @since 3.0.0
 */
export interface Monad2C<M extends HKT2, E> extends Pointed2C<M, E>, Chain2C<M, E> {}

/**
 * @category type classes
 * @since 3.0.0
 */
export interface Monad3<M extends HKT3> extends Pointed3<M>, Chain3<M> {}

/**
 * @category type classes
 * @since 3.0.0
 */
export interface Monad3C<M extends HKT3, E> extends Pointed3C<M, E>, Chain3C<M, E> {}

/**
 * @category type classes
 * @since 3.0.0
 */
export interface Monad4<M extends HKT4> extends Pointed4<M>, Chain4<M> {}
