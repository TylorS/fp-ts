 ...
 * @since 3.0.0
 */
export interface Chain1<M extends HKT> extends Functor1<M> {
  readonly chain: <A, B>(f: (a: A) => Kind<M, B>) => (ma: Kind<M, A>) => Kind<M, B>
}
 ...
 * @since 3.0.0
 */
export interface Chain2<M extends HKT2> extends Functor2<M> {
 ...
 * @since 3.0.0
 */
export interface Chain2C<M extends HKT2, E> extends Functor2C<M, E> {
 ...
 * @since 3.0.0
 */
export interface Chain3<M extends HKT3> extends Functor3<M> {
 ...
 * @since 3.0.0
 */
export interface Chain3C<M extends HKT3, E> extends Functor3C<M, E> {
 ...
 * @since 3.0.0
 */
export interface Chain4<M extends HKT4> extends Functor4<M> {
 ...
 * @since 3.0.0
 */
export function ap<F extends HKT4>(M: Chain4<F>): Apply4<F>['ap']
export function ap<F extends HKT3>(M: Chain3<F>): Apply3<F>['ap']
export function ap<F extends HKT3, E>(M: Chain3C<F, E>): Apply3C<F, E>['ap']
export function ap<F extends HKT2>(M: Chain2<F>): Apply2<F>['ap']
export function ap<F extends HKT2, E>(M: Chain2C<F, E>): Apply2C<F, E>['ap']
export function ap<F extends HKT>(M: Chain1<F>): Apply1<F>['ap']
