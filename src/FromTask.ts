 ...
 * @since 3.0.0
 */
export interface FromTask1<F extends HKT> extends FromIO1<F> {
 ...
 * @since 3.0.0
 */
export interface FromTask2<F extends HKT2> extends FromIO2<F> {
 ...
 * @since 3.0.0
 */
export interface FromTask2C<F extends HKT2, E> extends FromIO2C<F, E> {
 ...
 * @since 3.0.0
 */
export interface FromTask3<F extends HKT3> extends FromIO3<F> {
 ...
 * @since 3.0.0
 */
export interface FromTask3C<F extends HKT3, E> extends FromIO3C<F, E> {
 ...
 * @since 3.0.0
 */
export interface FromTask4<F extends HKT4> extends FromIO4<F> {
 ...
 * @since 3.0.0
 */
export function chainTaskK<M extends HKT4>(
  F: FromTask4<M>,
  M: Chain4<M>
): <A, B>(f: (a: A) => Task<B>) => <S, R, E>(first: Kind4<M, S, R, E, A>) => Kind4<M, S, R, E, B>
export function chainTaskK<M extends HKT3>(
  F: FromTask3<M>,
  M: Chain3<M>
): <A, B>(f: (a: A) => Task<B>) => <R, E>(first: Kind3<M, R, E, A>) => Kind3<M, R, E, B>
export function chainTaskK<M extends HKT3, E>(
  F: FromTask3C<M, E>,
  M: Chain3C<M, E>
): <A, B>(f: (a: A) => Task<B>) => <R, E>(first: Kind3<M, R, E, A>) => Kind3<M, R, E, B>
export function chainTaskK<M extends HKT2>(
  F: FromTask2<M>,
  M: Chain2<M>
): <A, B>(f: (a: A) => Task<B>) => <E>(first: Kind2<M, E, A>) => Kind2<M, E, B>
export function chainTaskK<M extends HKT2, E>(
  F: FromTask2C<M, E>,
  M: Chain2C<M, E>
): <A, B>(f: (a: A) => Task<B>) => <E>(first: Kind2<M, E, A>) => Kind2<M, E, B>
 ...
 * @since 3.0.0
 */
export function chainFirstTaskK<M extends HKT4>(
  F: FromTask4<M>,
  M: Chain4<M>
): <A, B>(f: (a: A) => Task<B>) => <S, R, E>(first: Kind4<M, S, R, E, A>) => Kind4<M, S, R, E, A>
export function chainFirstTaskK<M extends HKT3>(
  F: FromTask3<M>,
  M: Chain3<M>
): <A, B>(f: (a: A) => Task<B>) => <R, E>(first: Kind3<M, R, E, A>) => Kind3<M, R, E, A>
export function chainFirstTaskK<M extends HKT3, E>(
  F: FromTask3C<M, E>,
  M: Chain3C<M, E>
): <A, B>(f: (a: A) => Task<B>) => <R, E>(first: Kind3<M, R, E, A>) => Kind3<M, R, E, A>
export function chainFirstTaskK<M extends HKT2>(
  F: FromTask2<M>,
  M: Chain2<M>
): <A, B>(f: (a: A) => Task<B>) => <E>(first: Kind2<M, E, A>) => Kind2<M, E, A>
export function chainFirstTaskK<M extends HKT2, E>(
  F: FromTask2C<M, E>,
  M: Chain2C<M, E>
): <A, B>(f: (a: A) => Task<B>) => <E>(first: Kind2<M, E, A>) => Kind2<M, E, A>
